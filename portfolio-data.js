window.PORTFOLIO_DATA = {
  ...
  custom: {
    ...
    estimate: {
      ...
      requirements: [
        { value: "action", label: "指定动作", example: "比心", difficulty: 0.8, time: 0.18 },
        { value: "clothing", label: "指定服饰", example: "原版服饰", difficulty: 0.7, time: 0.16 },
        { value: "expression", label: "指定表情", example: "开心、wink", difficulty: 0.5, time: 0.1 },
        { value: "background", label: "指定背景", example: "简单白色背景", difficulty: 0.9, time: 0.2 },
        { value: "body-part", label: "指定部位", example: "大胸", difficulty: 0.7, time: 0.15 },
      ],
    },
  },
